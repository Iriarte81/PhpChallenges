...
Herein are some progressive php challenges and their custom (created by me) and original (created by the challenges' creators) solutions (both included in the same file, one for each challenge).
